...
@ImplementedBy(DefaultProductOfferReverseRouter.class)
public interface ProductOfferReverseRouter extends SimpleProductOfferReverseRouter, LocalizedReverseRouter {
     ...
     */
    default Call productOfferPageCall(final String categoryIdentifier) {
        return productOfferPageCall(locale().toLanguageTag(), categoryIdentifier);
    }
     ...
     * @return the page call to access the product overview page of the products belonging to the given category.
     */
    Optional<Call> productOfferPageCall(final Category category);
}
